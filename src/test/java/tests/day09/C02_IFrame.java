...
public class C02_IFrame {
    ...
    public void test() throws InterruptedException {
        ...
        Assert.assertTrue(baslik.isEnabled(),"ulasilamiyor");
...
//        System.out.println(baslikYazielemneti.getText());
        ...
        driver.switchTo().frame(iframe);//driver.switchTo().frame(0);hizlidir, yukaridaki satira gerek yoktur
        WebElement inputM=driver.findElement(By.xpath("//*[@id='tinymce']"));
        inputM.clear();
        inputM.sendKeys("Sizi cok seviyorum");
